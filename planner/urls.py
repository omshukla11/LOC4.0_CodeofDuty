...
urlpatterns = [
    ...
    path('WorkoutDay/<int:pk_prog>/<int:pk>/', views.WorkoutDayView.as_view(), name='WorkoutDay'),
    path('WorkoutSession/<int:pk_prog>/<int:pk>/', views.WorkoutSessionView.as_view(), name='WorkoutSession'),
]