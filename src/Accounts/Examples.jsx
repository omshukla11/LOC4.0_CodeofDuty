    ...
    return (
        <Grid container >
            ...
            <Grid item xs={12} md={3} sm={6}>
                    ...
                    <div class="card">
		            <figure class="card__thumb">
			        <img src="https://chloeting.com/_next/static/media/peach-tank1.343621ce.jpg" alt="Picture by Kyle Cottrell" class="card__image" style={{width:"100%" , height:"100%"}} />
			        <figcaption class="card__caption">
                    ...
                    <div class="card">
		            <figure class="card__thumb">
			        <img src="https://i.pinimg.com/originals/cb/61/98/cb619825fdcc96d4226c97320e35e4e0.jpg" alt="Picture by Kyle Cottrell" class="card__image" style={{width:"100%" , height:"100%"}}/>
			        <figcaption class="card__caption">
